...
const SocialIcon = (props) => {
  const SocialMediaIconPath = (props) => {
    ...
    } else if (props.socialMedia === "Github") {
      return (
    ...
    } else if (props.socialMedia === "Email") {
      return (
        <>
          <path fill="none" d="M0 0h24v24H0z"></path>
  ...
  const SocialMediaIconViewBox = (socialMedia) => {
    if (socialMedia === "dev.to") {
      return "0 0 512 512";
